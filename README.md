...
NOTE: You can now specify if you product should not display viewport buttons, simpyl add product: 0 parameter to the product object in the list above. If not present or value is different, buttons will be showby default for each product.
